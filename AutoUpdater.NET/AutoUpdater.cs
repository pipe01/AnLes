...
namespace AutoUpdaterDotNET
{
    ...
    public static class AutoUpdater
    {
        ...
        internal static Assembly mainAssembly = Assembly.GetEntryAssembly();
        ...
        {
            Start(appCast, mainAssembly.GetName().Version);
        }
        ...
        /// </summary>
        /// <param name="appCast">URL of the xml file that contains information about latest version of the application.</param>
        /// <param name="installedVersion">Use this version instead of the assembly's</param>
        public static void Start(string appCast, Version installedVersion)
        {
