    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            ...
            if (Program.serialPort.IsOpen)
            {
                ...
                foreach (var item in tbScale.Series)
                {
                    item.Points.Clear();
                }

                tbScale.ChartAreas[0].AxisX.ScaleView.SizeType = System.Windows.Forms.DataVisualization.Charting.DateTimeIntervalType.Minutes;
                tbScale.ChartAreas[0].AxisX.ScaleView.Size = 5;
            }
        }
        ...
        private void Tick()
        {
            ...
            /*if (!skipTick)
            {
                if (seriesChangesApply)
                {
                    liveChart1.AddOneSeries(series, elapsed.Elapsed);
                    seriesChangesApply = false;
                }
                else
                {
                    liveChart1.AddOneSeries(elapsed.Elapsed);
                }
            }
            else
            {
            ...
            /*tbScale.Invoke((MethodInvoker)delegate
            {
                if (tbScale.ChartAreas[0].AxisX.Maximum > tbScale.ChartAreas[0].AxisX.ScaleView.Size)
                {
                    tbScale.ChartAreas[0].AxisX.ScaleView.Scroll(tbScale.ChartAreas[0].AxisX.Maximum);
                }
            });*/
        }
